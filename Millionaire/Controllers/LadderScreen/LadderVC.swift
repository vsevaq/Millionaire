...
class LadderVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        case 1:
            print("Ответ 1")
            q1Label.image = UIImage(named: "Rectangle green")
        case 2:
            print("Ответ 2")
            q2Label.image = UIImage(named: "Rectangle green")
        case 3:
            print("Ответ 3")
            q3Label.image = UIImage(named: "Rectangle green")
        case 4:
            print("Ответ 4")
            q4Label.image = UIImage(named: "Rectangle green")
        case 5:
            print("Ответ 5")
            q5Label.image = UIImage(named: "Rectangle green")
        case 6:
            print("Ответ 6")
            q6Label.image = UIImage(named: "Rectangle green")
        case 7:
            print("Ответ 7")
            q7Label.image = UIImage(named: "Rectangle green")
        case 8:
            print("Ответ 8")
            q8Label.image = UIImage(named: "Rectangle green")
        case 9:
            print("Ответ 9")
            q9Label.image = UIImage(named: "Rectangle green")
        case 10:
            print("Ответ 10")
            q10Label.image = UIImage(named: "Rectangle green")
        case 11:
            print("Ответ 11")
            q11Label.image = UIImage(named: "Rectangle green")
        case 12:
            print("Ответ 12")
            q12Label.image = UIImage(named: "Rectangle green")
        case 13:
            print("Ответ 13")
            q13Label.image = UIImage(named: "Rectangle green")
        case 14:
            print("Ответ 14")
            q14Label.image = UIImage(named: "Rectangle green")
        case 15:
            print("Ответ 15")
            q15Label.image = UIImage(named: "Rectangle green")
        default:
